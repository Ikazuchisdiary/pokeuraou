...
def main() -> None:
    ...
    #
    # And once per distinct OBJECT, because the two arms may now be one: a shared leaf has
    # one socket and one set of counters, and printing them twice would read as twice the
    # traffic.
